<div class="search-form-1">
	<div class="search-content">
		...
		<div class="product-cats">
			<label><input type="radio" name="category_id" value="0" checked="checked"><span><?php echo $theme_options->get( 'all_categories_text', $config->get( 'config_language_id' ) ) != '' ? $theme_options->get( 'all_categories_text', $config->get( 'config_language_id' ) ) : 'All';  ?></span></label>
