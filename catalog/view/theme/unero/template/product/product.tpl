  	...
  	<div class="row">
  		...
  		<div class="col-sm-<?php if($theme_options->get( 'custom_block', 'product_page', $config->get( 'config_language_id' ), 'status' ) == 1 || count($product_custom_block)) { echo 9; } else { echo 12; } ?>">
  			<div class="row" id="quickview_product">
			    ...
			    <?php } ?>
			    <?php $image_grid = 7; $product_center_grid = 4; 
			    if ($theme_options->get( 'product_image_size' ) == 1) {
			    	$image_grid = 5; $product_center_grid = 6;
			    }
			    
			    if ($theme_options->get( 'product_image_size' ) == 3) {
			    	$image_grid = 8; $product_center_grid = 3;
			    }
			    ?>
			    <div class="col-lg-<?php echo $image_grid; ?> popup-gallery">
			      <?php 
			    ...
			    <div class="col-lg-<?php echo $product_center_grid; ?> col-lg-offset-1 product-center clearfix">
			     <div itemprop="offerDetails" itemscope itemtype="http://schema.org/Offer">
			      ...
			      <div class="price">
			        ...
			        <?php } else { ?>
			        <span class="price-new2"><span itemprop="price" id="price-special"><?php echo $special; ?></span></span> <span class="price-old" id="price-old"><?php echo $price; ?></span>
			        <?php } ?>
			        <br />
			        <?php if ($tax) { ?>
			      ...
			      <div class="options">
			        ...
			        <div class="form-group<?php echo ($option['required'] ? ' required' : ''); ?>">
			          ...
			          <div id="input-option<?php echo $option['product_option_id']; ?>">
			            <?php foreach ($option['product_option_value'] as $option_value) { ?>
			            <div class="radio <?php if($theme_options->get( 'product_page_radio_style' ) == 1 && !isset($option_value['image'])) { echo 'radio-type-button2'; } elseif($theme_options->get( 'product_page_radio_style' ) == 1 && isset($option_value['image'])) { echo 'radio-type-button'; } ?>">
			              <label>
			                <input type="radio" name="option[<?php echo $option['product_option_id']; ?>]" value="<?php echo $option_value['product_option_value_id']; ?>" />
			                
			                <?php if ($option_value['image'] && $theme_options->get( 'product_page_radio_style' ) != 1) { ?>
			                <img src="<?php echo $option_value['image']; ?>" alt="<?php echo $option_value['name'] . ($option_value['price'] ? ' ' . $option_value['price_prefix'] . $option_value['price'] : ''); ?>" class="img-thumbnail" /> 
			                <?php } ?> 
			                
			            	<?php if($theme_options->get( 'product_page_radio_style' ) == 1 && isset($option_value['image'])) { ?>
			            	<span data-toggle="tooltip" data-placement="top" title="<?php echo $option_value['name']; ?> <?php if ($option_value['price']) { ?>(<?php echo $option_value['price_prefix']; ?><?php echo $option_value['price']; ?>)<?php } ?>">
			            		<img src="<?php echo $option_value['image']; ?>" alt="<?php echo $option_value['name'] . ($option_value['price'] ? ' ' . $option_value['price_prefix'] . $option_value['price'] : ''); ?>" width="<?php if($theme_options->get( 'product_page_radio_image_width' ) > 0) { echo $theme_options->get( 'product_page_radio_image_width' ); } else { echo 25; } ?>px" height="<?php if($theme_options->get( 'product_page_radio_image_height' ) > 0) { echo $theme_options->get( 'product_page_radio_image_height' ); } else { echo 25; } ?>px" />
			            	</span>
			            	<?php } else { ?>
			            	<span>
			        ...
			        <div class="form-group<?php echo ($option['required'] ? ' required' : ''); ?>">
			          ...
			          <div id="input-option<?php echo $option['product_option_id']; ?>">
			            <?php foreach ($option['product_option_value'] as $option_value) { ?>
			            <div class="checkbox <?php if($theme_options->get( 'product_page_checkbox_style' ) == 1 && !isset($option_value['image'])) { echo 'radio-type-button2'; } elseif($theme_options->get( 'product_page_checkbox_style' ) == 1 && isset($option_value['image'])) { echo 'radio-type-button'; } ?>">
			              <label>
			                <input type="checkbox" name="option[<?php echo $option['product_option_id']; ?>][]" value="<?php echo $option_value['product_option_value_id']; ?>" />
			                
			                <?php if ($option_value['image'] && $theme_options->get( 'product_page_checkbox_style' ) != 1) { ?>
			                <img src="<?php echo $option_value['image']; ?>" alt="<?php echo $option_value['name'] . ($option_value['price'] ? ' ' . $option_value['price_prefix'] . $option_value['price'] : ''); ?>" class="img-thumbnail" /> 
			                <?php } ?> 
